...
import cl.onesnap.angulartest.web.filter.CachingHttpHeadersFilter;
import cl.onesnap.angulartest.web.filter.StaticResourcesProductionFilter;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    @Inject
    private AngularTestProperties props;
